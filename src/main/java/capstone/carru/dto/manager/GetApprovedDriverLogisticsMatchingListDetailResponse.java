...
@Getter
@Builder
public class GetApprovedDriverLogisticsMatchingListDetailResponse {
    ...
    public static GetApprovedDriverLogisticsMatchingListDetailResponse of(
            Product product) {
        return GetApprovedDriverLogisticsMatchingListDetailResponse.builder()
