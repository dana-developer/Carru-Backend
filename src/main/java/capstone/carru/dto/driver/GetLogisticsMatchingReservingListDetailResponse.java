...
@Getter
@Builder
public class GetLogisticsMatchingReservingListDetailResponse {
    ...
    public static GetLogisticsMatchingReservingListDetailResponse of(Product product) {
        return GetLogisticsMatchingReservingListDetailResponse.builder()
