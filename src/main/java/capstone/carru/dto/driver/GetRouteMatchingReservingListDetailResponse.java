...
@Getter
@Builder
public class GetRouteMatchingReservingListDetailResponse {
    //경유지 정보
    ...
    public static GetRouteMatchingReservingListDetailResponse of(ProductRouteReservation productRouteReservation){
        return GetRouteMatchingReservingListDetailResponse.builder()
